...
public class List_of_Reservations_Guest_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_of__reservations__guest_);
    ...
    private void ShowSQLiteDBdata( ) {
        ...
        cursor = sqLiteDatabase.rawQuery("SELECT *  FROM "+SQLiteHelper.Reservations + " WHERE reservation_date = '" + date + "' ", null);
        ...
        if (cursor.moveToNext()) {
            do {
                ...
                HotelName_Array.add(cursor.getString(cursor.getColumnIndex(SQLiteHelper.Hotel_name)));

                HotelLocation_Array.add(cursor.getString(cursor.getColumnIndex(SQLiteHelper.Hotel_location)));

                Number_Of_Nights_Array.add(cursor.getString(cursor.getColumnIndex(SQLiteHelper.Number_of_nights)));

                Price_Per_Night_Array.add(cursor.getString(cursor.getColumnIndex(SQLiteHelper.Price_per_night)));
